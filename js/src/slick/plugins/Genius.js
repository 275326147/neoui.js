...
define( function() {
	...
	var Genius = function( $G ) {
		...
		return function( e ) {
			...
			var 
                        dropdown = "<div class='slick-genius-wrapper' tabindex=1>" +
			...
			dropdown = $( dropdown )
				...
				.css( {
					"position": "absolute",
					"top": offset.top + trigger.height() + 22,
					"left": offset.left
				} )
			...
			setTimeout( function( e ) { dropdown.addClass( "show" ); } );
			setTimeout( function( e ) { dropdown.focus(); }, 300 );
		};
	};
